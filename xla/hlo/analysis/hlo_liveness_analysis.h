...
class HloLivenessAnalysis {
 public:
  ...
  // addressed by local id, so query them before a computation renumbers its
  // instructions (HloComputation::Cleanup after a removal, or
 ...
 private:
  ...
  // in the module when the analysis ran.
